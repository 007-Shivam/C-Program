...
void main()
{
  ...
  switch (n) {
               ...
               case 2: 
                       ...
                       printf("Enter the value of length of cuboid (l): ");
                       scanf("%f",&l); 
               ...
               case 4: 
                       ...
                       printf("Enter the value of radius of cylinder (r): ");
                       scanf("%f",&r);  
               ...
               case 5: 
                       ...
                       printf("Enter the value of radius of cone (r): ");
                       scanf("%f",&r);  
              ...
              default:  printf("Invalid input . Please run the program again");     
